const STORAGE_KEY = "lifeplus_sales_console_v43";
...
function createDefaultData() {
  return {
    ...
    whatsapp: [
      {
        id: "ws-suave",
        title: "Contacto inicial - calido",
        text:
          "Hola, soy Peter de LifePlus Pets.\n\nGracias por atenderme antes. Te paso por aqui la info de Care & Comfort, como me comentaste.\n\nEs un spray externo para perros, sin permetrina, pensado para familias que preguntan por opciones mas naturales y faciles de incorporar a la rutina diaria. No lo planteamos como sustituto del criterio veterinario, sino como una opcion complementaria y sencilla de explicar cuando encaja.\n\nTe envio un video corto y la ficha con ingredientes y modo de uso:\nWeb: www.petvitalityhub.com\nFicha: www.petvitalityhub.com/guia.html#care-comfort\nVideos: www.petvitalityhub.com/videos.html\n\nSi no eres tu quien lo lleva en la clinica, con que me digas a quien se lo puedo reenviar me ayudas muchisimo.",
      },
      {
        id: "ws-envio-info",
        title: "Envio de informacion tras llamada",
        text:
          "Hola, soy Peter de LifePlus Pets.\n\nGracias por decirme que os lo enviara por WhatsApp. Te paso la informacion breve de Care & Comfort, un spray de uso externo para perros pensado para familias que buscan una rutina mas natural y sencilla frente a pulgas, garrapatas, mosquitos, moscas y otros parasitos externos.\n\nLo que mas suele interesar a clinicas es que no lleva permetrina, es solo para perros y se puede explicar facilmente como apoyo externo, sin sustituir vuestro criterio veterinario ni los protocolos que ya useis cuando hay riesgo clinico.\n\nTe dejo aqui:\n- video corto con resumen: www.petvitalityhub.com/videos.html\n- ficha/guia con ingredientes y modo de uso: www.petvitalityhub.com/guia.html#care-comfort\n- web general: www.petvitalityhub.com\n\nSi te parece, dime quien seria la persona adecuada para valorarlo en el centro y le envio la informacion mas tecnica.",
      },
      {
        id: "ws-seguimiento",
        title: "Mensaje de seguimiento",
        text:
          "Hola, retomo por aqui el mensaje de Care & Comfort por si se te paso.\n\nTe dejo de nuevo la ficha y los videos, por si os resulta mas comodo revisarlo rapido:\nFicha: www.petvitalityhub.com/guia.html#care-comfort\nVideos: www.petvitalityhub.com/videos.html\n\nEs una informacion breve y sin compromiso. Si no es tu area, con que me digas quien lo lleva me vale. Un saludo!",
      },
      {
        id: "ws-tecnico",
    ...
    productos: [
      {
        ...
        pageUrl: "https://petvitalityhub.com/guia.html#care-comfort",
        videoUrl: "https://petvitalityhub.com/videos.html",
        shopUrl: "https://ww1.lifeplus.com/SHVCB5/M/es/es/product-details/3540/lifeplus-pets%AE-care-%26-comfort",
      },
      {
        name: "Ahiflower Oil",
        ...
        pageUrl: "https://petvitalityhub.com/guia.html#ahiflower",
        videoUrl: "https://petvitalityhub.com/videos.html",
        shopUrl: "https://ww1.lifeplus.com/SHVCB5/M/es/es/product-details/3545/lifeplus-pets%AE-ahiflower%AE-oil",
      },
      {
        name: "Move",
        ...
        pageUrl: "https://petvitalityhub.com/guia.html#move",
        videoUrl: "https://petvitalityhub.com/videos.html",
        shopUrl: "https://ww1.lifeplus.com/SHVCB5/M/es/es/product-details/3535/lifeplus-pets%AE-move",
      },
      {
        name: "Digest",
        ...
        pageUrl: "https://petvitalityhub.com/guia.html#digest",
        videoUrl: "https://petvitalityhub.com/videos.html",
        shopUrl: "https://ww1.lifeplus.com/SHVCB5/M/es/es/product-details/3536/lifeplus-pets%AE-digest",
      },
      {
        name: "Calm",
        promise: "Apoyo natural para calma y adaptacion diaria.",
        ingredient: "C10 Calming Colostrum Complex",
        use: "Presentar ante estres, cambios de rutina o sensibilidad.",
        pageUrl: "https://petvitalityhub.com/guia.html#calm",
        videoUrl: "https://petvitalityhub.com/videos.html",
        shopUrl: "https://ww1.lifeplus.com/SHVCB5/M/es/es/product-details/3534/lifeplus-pets%AE-calm",
      },
      {
        name: "Biscuits",
        promise: "Premio funcional para una rutina sencilla.",
        ingredient: "Proteina + grasas saludables",
        use: "Presentar como entrada facil a la linea Pets.",
        pageUrl: "https://petvitalityhub.com/guia.html#biscuits",
        videoUrl: "https://petvitalityhub.com/videos.html",
        shopUrl: "https://ww1.lifeplus.com/SHVCB5/M/es/es/product-details/5390/lifeplus-pets%AE-peanut-butter-biscuits",
      },
    ],
  };
}
      ...
      (product) => `
        <article class="product-card">
          ...
          <div class="product-actions">
            ${product.pageUrl ? `<a href="${escapeHtml(product.pageUrl)}" target="_blank" rel="noopener">Ficha</a>` : ""}
            ${product.videoUrl ? `<a href="${escapeHtml(product.videoUrl)}" target="_blank" rel="noopener">Videos</a>` : ""}
            ${product.shopUrl ? `<a href="${escapeHtml(product.shopUrl)}" target="_blank" rel="noopener">Tienda</a>` : ""}
          </div>
        </article>
      `,
    )
